...
function initServer(ctx) {
    ...
    function syncVigilCLIHooks() {
        try {
            ...
            const { registerHooks } = require("../hooks/src/install.ts");
    ...
    function syncGeminiHooks() {
        try {
            // eslint-disable-next-line @typescript-eslint/no-var-requires
            const { registerGeminiHooks } = require("../hooks/src/gemini-install.ts");
    ...
    function syncCodeBuddyHooks() {
        try {
            // eslint-disable-next-line @typescript-eslint/no-var-requires
            const { registerCodeBuddyHooks } = require("../hooks/src/codebuddy-install.ts");
    ...
    function syncCursorHooks() {
        try {
            // eslint-disable-next-line @typescript-eslint/no-var-requires
            const { registerCursorHooks } = require("../hooks/src/cursor-install.ts");
